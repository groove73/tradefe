...
export function ProductSummaryCards({ data, productType }: ProductSummaryCardsProps) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <Card className="p-6 bg-white border-gray-100 shadow-xl shadow-gray-100/50">
                ...
                <div className="text-[10px] mt-2 text-gray-400 font-medium">{productType} 합계</div>
            </Card>
        </div>
    )
}
